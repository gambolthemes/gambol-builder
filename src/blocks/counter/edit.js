...
export default function Edit( { attributes, setAttributes } ) {
	...
	const layoutTab = (
		<>
			<Section title={ __( 'Counter Value', 'gambol-builder' ) }>
				<RangeSlider
					label={ __( 'Start Value', 'gambol-builder' ) }
					value={ startValue }
					min={ 0 }
					max={ 10000 }
					step={ 1 }
				...
				/>
				<RangeSlider
					label={ __( 'End Value', 'gambol-builder' ) }
					value={ endValue }
					min={ 0 }
					max={ 100000 }
					step={ 1 }
				...
				/>
				<TextInput
					label={ __( 'Prefix', 'gambol-builder' ) }
					value={ prefix }
					onChange={ ( value ) => setAttributes( { prefix: value } ) }
					placeholder="$"
				/>
				<TextInput
					label={ __( 'Suffix', 'gambol-builder' ) }
					value={ suffix }
					onChange={ ( value ) => setAttributes( { suffix: value } ) }
					placeholder="+, %, K"
				/>
				<Toggle
					label={ __( 'Thousand Separator', 'gambol-builder' ) }
					checked={ separator }
	...
	const designTab = (
		<>
			<Section title={ __( 'Colors', 'gambol-builder' ) }>
				...
				/>
				<GambolColorPicker
					label={ __( 'Number Color', 'gambol-builder' ) }
					value={ numberColor }
			...
			<Section title={ __( 'Typography', 'gambol-builder' ) }>
				<RangeSlider
					label={ __( 'Number Size', 'gambol-builder' ) }
					value={ numberSize }
					min={ 24 }
					max={ 100 }
					step={ 2 }
	...
	return (
		<>
			<InspectorControls>
				<InspectorSidebar
					blockTitle={ __( 'Counter', 'gambol-builder' ) }
					blockIcon={ <CounterHeaderIcon /> }
					layoutTab={ layoutTab }
					designTab={ designTab }
			...
			<div { ...blockProps }>
				...
				<div className="gambol-counter__content">
					<div className="gambol-counter__number">
						<span className="gambol-counter__prefix">{ prefix }</span>
						<span className="gambol-counter__value">{ formatNumber( endValue ) }</span>
						<span className="gambol-counter__suffix">{ suffix }</span>
					</div>
