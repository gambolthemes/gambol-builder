/**
 * Page Title Block - Edit Component
 *
...
export default function Edit( { attributes, setAttributes, context } ) {
	...
	const blockProps = useBlockProps( {
		className: 'wp-block-gambol-page-title',
	} );

	// Get the current post type and ID from context or editor
	...
	const TitleContent = () => (
		<TagName className="wp-block-gambol-page-title__heading" style={ titleStyle }>
	...
	return (
		<>
			<InspectorControls>
				<InspectorSidebar
					blockTitle={ __( 'Page Title', 'gambol-builder' ) }
					blockIcon={
			...
			<div { ...blockProps }>
				{ isLink ? (
					<a href={ permalink } className="wp-block-gambol-page-title__link">
						<TitleContent />
					</a>
				) : (
					<TitleContent />
